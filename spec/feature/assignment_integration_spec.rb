...
RSpec.describe 'Creating an assignment', type: :feature do
  scenario 'valid inputs' do
    ...
    select(Request.find_by_phone_number('2105270414').request_id, from: 'assignment_request_id')
...
RSpec.describe 'Showing an assignment', type: :feature do
  scenario 'show inputs' do
    ...
    fill_in 'Driver', with: 7
    click_on 'Create Assignment'
    visit assignment_path(Assignment.find_by_request_id(Request.find_by_phone_number('2105270414')))
    expect(page).to have_content('In Progress')
    expect(page).to have_content('7')
  end
end
...
RSpec.describe 'Changing status of an assignment', type: :feature do
  scenario 'change status' do
    ...
    fill_in 'Driver', with: 7
    click_on 'Create Assignment'
    visit request_status_path(Request.find_by_phone_number('2105270414'))
