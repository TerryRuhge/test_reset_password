...
RSpec.describe Member, type: :model do
    let(:member) { Member.create!(first_name: 'TestName', last_name: 'TestName', phone: '8324616853', address: '987239yr8', emergency_phone_number: "8578575843", emergency_full_name: 'TestName', emergency_full_name: '987346823476587264', email: 'adjdhflkajhsd@gjalsdm.com', password: '123456', password_confirmation: '123456')}
    # before :each do
    #     sign_in member
    # end
#   subject do
